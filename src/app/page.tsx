  ...
  return (
    <main className="flex-1 md:ml-64 lg:mr-64">
      <div className="p-8">
        ...
        <Title level={3} className="mt-8" extendClassName>Courses</Title>
        <Box className="space-y-4">
          <Paragraph>I'm always learning something different to improve my skills along my career.</Paragraph>
          <Paragraph>Here you have the recent courses that I've finished</Paragraph>
        </Box>
        <div className="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="text-white font-bold text-center">Certificate</TableHead>
                <TableHead className="text-white font-bold text-right">Date</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
